...
import fr.fredgodard.chatop.exceptions.FileStorageException;
...
public class FileStorageService {
    ...
    public void saveFile(MultipartFile file, String subPath) throws FileStorageException {
        try {
            Path filePath = rootPath.resolve(subPath);
            Files.createDirectories(filePath.getParent());
            file.transferTo(filePath);
        } catch (IOException e) {
            throw new FileStorageException("Picture has not been saved.", e);
        }
    }
