...
import fr.fredgodard.chatop.exceptions.RentalNotFoundException;
...
public class RentalService {
    ...
    public Rental getRental(Integer rentalId) throws RentalNotFoundException {
        ...
        if (rentalEntity.isEmpty()) {
            throw new RentalNotFoundException("Rental not found ! ", null);
        }
    ...
    private Rental entity2Rental(RentalEntity rental, final String contextPath) {
        ...
        result.setCreatedAt(rental.getCreated_at());
        result.setUpdatedAt(rental.getUpdated_at());
        return result;
    }
